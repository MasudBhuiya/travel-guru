    ...
    return (
        ...
        <div className='w-[500px]  mt-16 mx-auto border rounded-lg  px-16 py-6 border-slate-300'>
            ...
            <form onSubmit={handleLogin} className='' action="">
                ...
                <input type="email" name="email" className='border-b border-black  p-3' placeholder='Enter Your Email' required  />
                </div>
                <div className='flex flex-col'>
                <input type={show? 'text': 'password'} name="password" className='border-b  border-black p-3' placeholder='Password' required  />
                <p onClick={()=>setShow(!show)}><small className='btn btn-xs mt-2 bg-orange-300'>{show ? 'Hide' : 'Show'}</small></p>
                </div>
                <div className='flex justify-between items-center'>
                <div className='flex mt-2 items-center gap-1'>
                    <input type="checkbox" name=""  /> <p className='mb-1'>remember me</p>
                </div>
            ...
            <p className='text-center'><small>Don`t have an account?<Link to="/register" className='btn btn-link text-orange-400'>Create New Account</Link></small></p>
